...
export async function fetchMasterReport() {
  ...
  return (requisitions || []).map((req) => {
    ...
    return {
      ...
      vendor_name: rollup?.vendor_name ?? (req.vendor_id ? vendorNameById[req.vendor_id] || "Unknown vendor" : null),
      is_split_across_vendors: rollup?.is_split_across_vendors || false,
